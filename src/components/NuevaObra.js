...
export default function NuevaObra() {
  ...
  // Cargar usuarios con área jefe_obra
  useEffect(() => {
  ...
  async function handleSubmit(e) {
    ...
    // 2. Asignar jefe si se seleccionó
    if (jefeSelec) {
      const { error: asigErr } = await supabase
        .from('usuario_obra')
        .insert([{ obra_id: obraData.id, usuario_id: jefeSelec }]);

      if (asigErr) {
        // La obra ya se creó — avisamos pero no bloqueamos
        console.warn('No se pudo asignar el jefe de obra:', asigErr.message);
      }
    }
  ...
  return (
    <div className="nueva-obra">
      <div className="nueva-obra__inner">
        ...
        <button className="nueva-obra__back" onClick={() => navigate(-1)}>
          ← Volver
        </button>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-group">
            ...
            <input
              className="form-input"
              placeholder="ej. Casa Aguerre — Miramar"
              value={form.nombre}
          ...
          <div className="form-group--half">
            ...
            <div className="form-group">
              ...
              <select
                className="form-select"
                value={form.categoria_obra}
                onChange={e => set('categoria_obra', e.target.value)}
              >
            ...
            <div className="form-group">
              ...
              <div className="form-input--prefix-wrap">
                ...
                <input
                  ...
                  placeholder="0.00"
                  value={form.dolar}
                  onChange={e => set('dolar', e.target.value)}
                />
              </div>
            ...
            <div className="form-group">
              ...
              <div className="form-input--prefix-wrap">
                ...
                <input
                  ...
                  min="0"
                  placeholder="0.00"
                  value={form.costo_previsto_total}
                  onChange={e => set('costo_previsto_total', e.target.value)}
                />
              </div>
          ...
          <div className="form-group--half">
            <div className="form-group">
              ...
              <div className="form-input--prefix-wrap">
                <span className="prefix" style={{ left: 'auto', right: 14, transform: 'translateY(-50%)' }}>m²</span>
                <input
                  className="form-input"
                  type="number"
                  min="0"
            ...
            <div className="form-group">
              ...
              <input
                className="form-input"
                placeholder="ej. Estudio Bértola"
                value={form.cliente}
          ...
          <div className="form-group">
            <div
              ...
              onClick={() => set('es_obra_basica', !form.es_obra_basica)}
            >
            ...
            <div className="jefe-grid">
              {jefes.map(j => (
                ...
                >
                  ...
                  <div className="jefe-check">
                    <div className="jefe-check-inner" />
                  </div>
                </div>
              ))}
